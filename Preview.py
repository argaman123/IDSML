...
trainingDS = Dataset(filename="150218IDS.csv", resultsColumn='Label', dataTypes=dTypes, numrows=1000000)
testingDS = Dataset(filename="150218IDS.csv", resultsColumn='Label', dataTypes=dTypes, numrows=50000, skiprows=list(range(1,1000000)))
dataHandler = DatasetHandler(filename="150218IDS.csv", trainingDS=trainingDS, testingDS=testingDS, normalText="Benign", droppedColumns=['Timestamp', 'Flow Byts/s', 'Flow Pkts/s'])
