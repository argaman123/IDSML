...
trainingDS = Dataset(filename="150218IDS.csv", resultsColumn='Label', dataTypes=dTypes, numrows=200000)
testingDS = Dataset(filename="150218IDS.csv", resultsColumn='Label', dataTypes=dTypes, numrows=50000, skiprows=list(range(1,200000)))
